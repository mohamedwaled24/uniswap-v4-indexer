...
export const USDC_MAINNET_ADDRESS = '0x5d1abc83973c773d122ae7c551251cc9be2baecc'
...
export const TEST_CONFIG: IndexerConfig = {
...
//   const fixtures: { [key: string]: TokenFixture } = {
//     [USDC_MAINNET_ADDRESS]: USDC_MAINNET_FIXTURE,
//     [WETH_MAINNET_ADDRESS]: WETH_MAINNET_FIXTURE,
//     [WBTC_MAINNET_ADDRESS]: WBTC_MAINNET_FIXTURE,
//   }

//   const fixture = fixtures[tokenAddress]
//   if (!fixture) {
...
export interface PoolKeyFixture {
  id: string
  token0: string
  token1: string
  fee: number
...
export interface PositionConfigFixture {
  id: string
...
// export const getPoolFixture2 = (poolAddress: string): PoolFixture => {
...
export const TEST_ETH_PRICE_USD = BigDecimal('2000')
export const TEST_USDC_DERIVED_ETH = BigDecimal('1').div(BigDecimal('2000'))
export const TEST_WETH_DERIVED_ETH = BigDecimal('1')

function generateRandomEthereumAddress(): string {
  let address = '0x';
  for (let i = 0; i < 20; i++) {
    // Generate a random byte (0-255) and convert it to a two-digit hex string.
...
export const POSITION_FIXTURE: PositionFixture = {
  id: '1',
  tokenId: BigInt(1),
  origin: generateRandomEthereumAddress(),
